...
const skillsSection = {
  ...
  skills: [
    ...
    emoji(
      "⚡ Develop Web3 applications / DAPPs on EVM and aptos"
    ),
    emoji("⚡ Progressive Web Applications ( PWA ) in normal and SPA Stacks"),
    emoji("⚡ Integration of OpenAI and other AI services"),
    emoji(
      "⚡ Integration of third party services such as Firebase / Stripe / SupaBase"
    ),
